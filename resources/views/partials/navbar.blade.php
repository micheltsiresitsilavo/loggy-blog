<nav
      class="  border-b-default border-solid border-gray-200 z-10 w-full bg-inherit lg:fixed backdrop-filter backdrop-blur-lg"
      id="topnav"
    >
          ...
          <div class="hidden w-full lg:flex justify-between max-lg:bg-white py-5 max-lg:mt-1 max-lg:px-4 max-lg:shadow-lg max-lg:shadow-gray-200 max-lg:h-auto max-lg:overflow-auto transition-all duration-500 delay-200 " id="navbar">
            ...
            >
              <li>
                <a
                  href="/"
                      class="{{ request()->is('/') ? 'text-red-500 text-sm font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 hover:text-red-400':'text-gray-500 text-sm font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 hover:text-gray-900' }}"
                  >Home</a
                >
              </li>
                <li>
                <a
                  href="/posts"
                      class="{{ request()->is('posts') ? 'text-red-500 text-sm font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 hover:text-red-400':'text-gray-500 text-sm font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 hover:text-gray-900' }}"
                  >BlogPost</a
                >
              </li>
              <li>
            ...
            <a href="https://pagedone.io/" class="hidden lg:flex items-center">
              <h1 class="text-2xl text-gray-800 font-bold">Loggy</h1>
            </a>
            <div
            ...
            >
              ...
              <a
              href="https://aisapien-chat.vercel.app"

      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
        ...
        >
          <span class="font-inter text-xs font-medium text-gray-900 ml-3"
            >Explore how to dev this Blog.</span
          >
          <a
            href="javascript:;"
        ...
        >
          A Laravel-Powered 
          <span class="text-indigo-600">Blogging Platform </span>
        </h1>
        <p
          class="max-w-sm mx-auto text-center text-base font-normal leading-7 text-gray-500 mb-9"
        >
          Loggy is a modern and feature-rich blogging platform built using the powerful PHP Laravel framework. It provides a seamless and user-friendly experience for both writers and readers.
        </p>
        <a
          href="/posts"

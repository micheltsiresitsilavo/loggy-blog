...
@section('content')
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">BlogPosts</h2>

      <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Embark on a illuminating odyssey through the realms of Laravel development, where debugging stories intertwine with invaluable skill-sharing, empowering you to craft exceptional digital experiences.</p>
    </div>
    <!-- text - end -->
    ...
    <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
      ...
      @foreach ($posts as $post)
          ...
          <div class="flex flex-col overflow-hidden rounded-lg border bg-white">
            <a href="{{ route('posts.show', ['id' => $post->id]) }} " class="group relative block h-48 overflow-hidden bg-gray-100 md:h-64">
              <img src="{{$post->getFirstMediaUrl('posts', 'thumb') }}"  alt="" class="h-full w-full object-cover object-center" />
            </a>
              ...
              <div class="mt-auto flex items-end justify-between">
                <div class="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <span class="block text-sm text-gray-400">{{ $post->created_at->format('m/d/Y') }}</span>
                  </div>
                </div>
